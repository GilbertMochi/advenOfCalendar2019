...
namespace _2ndDay
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"End result for finding noun and verb: {FindNounAndVerbForGivenResult(numArray, 19690720)}.");
        }

        static int FindNounAndVerbForGivenResult(int[] arr, int result)
        {
